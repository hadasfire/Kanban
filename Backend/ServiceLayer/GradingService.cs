...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return userSer.Register(email, password);
        }
        ...
        {
            return userSer.Login(email, password);
        }
        ...
        {
            return boardSer.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return boardSer.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return boardSer.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
            return taskSer.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return taskSer.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return taskSer.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return boardSer.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return boardSer.CreateBoard(email, name);
        }
        ...
        {
            return boardSer.DeleteBoard(email, name);
        }
